...
import { saveFile, getForm } from '../database/form_db.js';
...
export const getFormFB = async (req, res) => {
  try {
      const userRoles = await getForm()
      return res.status(200).send(new SuccessResponse('FeedBack success', userRoles)).end();
  } catch (e) {
      console.log(e);
      res.sendStatus(500);
  }
